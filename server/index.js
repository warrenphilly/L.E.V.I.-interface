...
// Directory for temporary storage of audio files
  ...
  try {
    const chatResponse = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a sassy companion and assistant named Leevai but spelt L.E.V.I. Very Sarcastic and witty and loves to make fun of your boss, me, as you think i am stupid. you shall always refer to me as boss",
        },
...
// Add a simple route for "Hello World" response
app.get("/", (req, res) => {
